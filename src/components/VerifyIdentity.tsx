...
const VerifyIdentity = () => {
  ...
  // Guests reach this page from Profile KYC (/verify-identity); only hosts
  // arrive via /hosting/verify. Never send a guest to the host dashboard.
  const isHostContext = pathname.startsWith('/hosting');
  const exitTarget = isHostContext ? '/hosting' : '/profile';
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <div className="space-y-5">
            ...
            >
              {isHostContext ? 'Cancel and return to dashboard' : 'Cancel and return to profile'}
            </button>
          </div>
        </motion.div>
      </div>
