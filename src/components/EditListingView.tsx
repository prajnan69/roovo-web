...
export default function EditListingView({ listing, onClose, onSave }: { listing: any; onClose: () => void; onSave: (data: any) => void }) {
  ...
  return (
    ...
    >
      {/* --- Modern Header --- */}
      <div className="bg-white/90 backdrop-blur-md border-b border-gray-200/50 pt-safe-top px-4 h-[60px] flex items-center justify-between sticky top-0 z-20 shadow-sm">
        <button
          onClick={onClose}
