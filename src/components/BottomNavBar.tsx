    ...
    <AnimatePresence>
      {show && (
        <motion.nav
          ...
          className="fixed bottom-6 left-1/2 z-50 w-[94%] max-w-md bg-white/90 backdrop-blur-xl border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.12)] rounded-2xl md:hidden"
        >
