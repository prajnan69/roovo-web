...
interface InfinityCheckLoaderProps {
    isLoading: boolean;
    className?: string;
    color?: string;
    size?: number | string;
...
export default InfinityCheckLoader;
