...
const SwitchingToTravelingLoader = ({ onAnimationComplete, onTransitionStart }: LoaderProps) => {
  const [toTraveling, setToTraveling] = useState(false);
    ...
    <div className="relative flex flex-col items-center justify-center w-full h-full">
      ...
      <div className="absolute bottom-1/4 text-center flex items-center gap-3">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            key={toTraveling ? "traveling" : "hosting"}
          ...
          >
            <RotatingText
              texts={toTraveling ? ["Traveling"] : ["Hosting"]}
...
export default SwitchingToTravelingLoader;
